...
module.exports = {
    config: {
        ...
        fontFamily: '"ComicShannsMono Nerd Font",   Menlo, "DejaVu Sans Mono", Consolas, "Lucida Console", monospace',
        ...
        hyperCat: {
            ...
            //   false will never play nyan videoß
    ...
    plugins: [// `hyperline`,
        // "hyper-cat",
        "hyperpower", "hyper-letters", "gitrocket", "hyper-material-theme", "hyperline",],
